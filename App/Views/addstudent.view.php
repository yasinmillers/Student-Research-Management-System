                                ...
                                <form role="form" method="post" enctype="multipart/form-data" action="/addStudent">
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input name="email" type="email" class="form-control"
                                                        placeholder="Email"><span class="ma-form-highlight"></span><span
                                                        class="ma-form-bar"></span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="passwordConfirmation" name="confirmpassword"
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="city" type="text" name="city" class="form-control"
                                                        placeholder="City"><span class="ma-form-highlight"></span><span
                                                        class="ma-form-bar"></span>
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="institute" type="text" name="institute"
                                                        class="form-control" placeholder="Institute Name"><span
                                                        class="ma-form-highlight"></span><span
                                                        class="ma-form-bar"></span>
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="semesteryear" type="text" name="semesteryear"
                                                        class="form-control" placeholder="Semester Year"><span
                                                        class="ma-form-highlight"></span><span
                                                        class="ma-form-bar"></span>
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <textarea id="aboutme" type="text" name="aboutme"
                                                        class="form-control"
                                                        placeholder="Tell us a little about yourself"></textarea><span
                                                        class="ma-form-highlight"></span><span
                                                        class="ma-form-bar"></span>
