                      ...
                      ?>
                            ...
                            endforeach; ?>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <a href="/viewapaper/<?= $i->id ?>"
                                                        class="btn btn-primary btn-xs ripple" data-toggle="tooltip"
                                                        data-placement="top" title="" data-original-title="View"><span
                                                            class="ink animate"
                                                            style="height: 22px; width: 22px; top: -4px; left: -6.1875px;"></span><i
                                                            class="fa fa-eye"></i></a>
                                                    <a href="/deletePaper/<?= $i->id ?>"
                                                        class="btn btn-danger btn-xs ripple" data-toggle="tooltip"
