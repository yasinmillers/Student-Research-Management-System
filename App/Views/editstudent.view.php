                        ...
                        <div class="panel panel-default text-center paper-shadow" data-z="0.5">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" method="post" enctype="multipart/form-data"
                                    action="/editStudent/<?= $i->id ?>">
                                    <center><img class="thumbnail width-80"
                                            src="/App/Data/images/users/<?= $i->profilepic ?>.jpg"></center>
                                    <div class="form-group">
                                        <div class="form-control-material">
                                            <input type="file" style="display:none" name="profilepic">
                                            <button id="addPhotoInput" class="btn btn-primary"><i
                                                    class="icon-user-1"></i> Upload Profile Picture</button>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="firstName" type="text" name="fname"
                                                        value="<?= $i->fname ?>" class="form-control"
                                        ...
                                        <div class="col-md-6 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="lastName" type="text" value="<?= $i->lname ?>"
                                                        name="lname" class="form-control" placeholder="Last Name"><span
                                                        class="ma-form-highlight"></span><span
                                                        class="ma-form-bar"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input name="email" type="email" value="<?= $i->email ?>"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="password" type="password" value="" name="password"
                                                        class="form-control"
                                                        placeholder="(Keep Blank For No Change)"><span
                                                        class="ma-form-highlight"></span><span
                                                        class="ma-form-bar"></span>
                                        ...
                                        <div class="col-md-6 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="passwordConfirmation" name="confirmpassword" value=""
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="">
                                                    <select name="gender" class="selectpicker" data-style="btn-white"
                                                        placeholder="Choose Gender" data-live-search="true"
                            ...
                            ?>
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    ...
                                                    <input id="datepicker" name="birthday"
                                                        value="<?= (!empty($i->birthday)) ? date("m/d/Y", strtotime($i->birthday)) : "01/01/2000" ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="city" type="text" name="city" value="<?= $i->city ?>"
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="country" type="text" name="country"
                                                        value="<?= $i->country ?>" class="form-control"
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="degree" type="text" name="degree"
                                                        value="<?= $i->degree ?>" class="form-control"
                                                        placeholder="Degree Programme"><span
                                                        class="ma-form-highlight"></span><span
                                                        class="ma-form-bar"></span>
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="institute" type="text" name="institute"
                                                        value="<?= $i->institute ?>" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <select name="semester" class="selectpicker" data-style="btn-white"
                                                    placeholder="Choose Semester" data-live-search="true" data-size="5"
                                                    style="display: none;">
                                                    <?php
                          ...
                          ?>
                                        ...
                                        <div class="col-md-6 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <input id="semesteryear" type="text" name="semesteryear"
                                                        value="<?= $i->semesteryear ?>" class="form-control"
                                                        placeholder="Semester Year"><span
                                                        class="ma-form-highlight"></span><span
                                                        class="ma-form-bar"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="form-control-material">
                                                    <textarea id="aboutme" type="text" name="aboutme"
                                                        class="form-control"
                                                        placeholder="Tell us a little about yourself"><?= $i->aboutme ?></textarea><span
                                                        class="ma-form-highlight"></span><span
                                                        class="ma-form-bar"></span>
