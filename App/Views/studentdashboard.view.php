            ...
            <div class="row">
                ...
                ?>
                                <li class="list-group-item paper-shadow">
                                    <div class="media v-middle">
                                        <div class="media-left">
                                            <a href="#">
                                                <img src="/App/Data/images/users/<?= $s->profilepic ?>.jpg" alt="person"
                                                    class="img-circle width-40">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                            <a href="#"
                                                class="text-subhead link-text-color text-capitalize"><?= $s->fname . ' ' . $s->lname ?></a>
                                            <div class="text-light text-capitalize">
                                                Education: <a href="#"><?= $s->education ?></a> &nbsp; Institution: <a
                                                    href="#"><?= $s->institute ?></a>
                                            </div>
                                        </div>
                                        <div class="media-right">
                                            <div class="width-80 text-right">
                                                <span
                                                    class="text-caption text-capitalize text-light"><?= $s->city . ', ' . $s->country ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="list-group-item paper-shadow">
                                    <div class="media v-middle">
                                        ...
                                        <div class="media-body">
                                            <a href="#" class="text-subhead link-text-color text-capitalize">No Faculty
                                                Members</a>
                                        </div>
                                    </div>
                                </li>
                ...
                ?>
                                    ...
                                    <div class="media v-middle">
                                        <div class="media-left">
                                            <a href="/viewPaper/<?= $s->id ?>">
                                                <span class="img-circle width-40"><i
                                                        class="fa fa-file fa-2x"></i></span>
                                            </a>
                                        </div>
                                        <div class="media-body">
                                            <a href="/viewPaper/<?= $s->id ?>"
                                                class="text-subhead link-text-color text-capitalize"><?= $s->title ?></a>
                                            <div class="text-light text-capitalize">
                                        ...
                                        <div class="media-right">
                                            <div class="width-80 text-right">
                                                <span
                                                    class="text-caption text-capitalize text-light"><?= date('d-M-Y', strtotime($s->createdat)) ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <div class="panel-footer">
                                    <a href="/viewpapers" class="btn btn-primary paper-shadow relative" data-z="0"
                                        data-hover-z="1" data-animated=""> View All</a>
                                </div>
                                <?php else : ?>
                                <li class="list-group-item paper-shadow">
                                    <div class="media v-middle">
                                        ...
                                        <div class="media-body">
                                            <a href="#" class="text-subhead link-text-color text-capitalize">No Papers
                                                Found !</a>
                                        </div>
                                    </div>
                                </li>
