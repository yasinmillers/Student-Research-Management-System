                ...
                <form method="post" action="/login">
                    <div class="form-group">
                        <div class="form-control-material">
                            ...
                            <select name="type" class="selectpicker" data-style="btn-white" placeholder="Login as"
                    ...
                    <div class="form-group">
                        <div class="form-control-material">
                            <input class="form-control" id="email" name="email" type="text" placeholder="Email"><span
                    ...
                    <div class="form-group">
                        <div class="form-control-material">
                            <input class="form-control" id="password" name="password" type="password"
                                placeholder="Enter Password"><span class="ma-form-highlight"></span><span
